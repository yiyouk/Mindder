...
public enum SuccessCode {
	...
	// alarms
	CREATE_PUSH_ALARMS(SUCCESS, "푸시 알림 전송 성공"), UPDATE_USER_TOKEN(SUCCESS, "fcm 토큰 등록 성공"),
	READ_ALARM_LIST(SUCCESS, "알림 목록 조회 성공"), UPDATE_ALARM(SUCCESS, "알림 읽음 처리 성공"), DELETE_ALARM(SUCCESS, "알림 삭제 성공"),
	DELETE_ALL_ALARM(SUCCESS, "알림 전체 삭제 성공"),
