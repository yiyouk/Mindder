...
public enum SuccessCode {
	...
	// feeds
	WRITE_MAIN_FEED(SUCCESS, "메인 피드 글 등록 성공"), UPDATE_MAIN_FEED(SUCCESS, "메인 피드 글 수정 성공"),
	DELETE_MAIN_FEED(SUCCESS, "메인 피드 글 삭제 성공"), DETAIL_MAIN_FEED(SUCCESS, "메인 피드 글 상세보기 성공"),
	NEIGHBORS_FEED_LIST(SUCCESS, "이웃 피드 글 보기 성공"), IMAGE_CRAAWLING_COLOR(SUCCESS, "이미지 크롤링 성공"),
